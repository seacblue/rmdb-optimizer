...
TEST(TypeCasterTest, NumericCastPriority) {
    ...
    EXPECT_EQ(widened.bigint_val, 42);
    ...
    EXPECT_EQ(narrowed.int_val, 2147483647);
...
TEST(TypeCasterTest, DateTimeCastAndCompare) {
    ...
    EXPECT_EQ(int64_to_datetime_str(dt_val.bigint_val), "2024-02-29 12:34:56");
...
TEST(TypeCasterTest, IntegerArithmeticPromotionAndOverflow) {
    ...
    EXPECT_EQ(sum.bigint_val, 2147483648LL);
